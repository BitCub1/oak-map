...
const OAKRoutes = (function () {
    ...
    var _SM_BRIDGE = [
        [37.573, -122.263], // San Mateo Bridge West End / Toll Plaza
        [37.589, -122.245], // Bridge span
        [37.591, -122.243], // Bridge span
        [37.617, -122.156], // San Mateo Bridge East End
        [37.622, -122.139], // CA-92 / Clawiter Rd
        [37.630, -122.116], // CA-92 / Hesperian Blvd
        [37.638, -122.098], // CA-92 / I-880 approach
        [37.628, -122.070], // I-880 Hayward interchange
        [37.670, -122.087],
        [37.697, -122.110],
        [37.707, -122.120],
        [37.735, -122.190],
    ...
    R["San Mateo"]     = [[37.554, -122.313], [37.552, -122.302], [37.556, -122.286], [37.561, -122.278], [37.565, -122.272]].concat(_SM_BRIDGE);
    R["Foster City"]   = [[37.559,-122.271], [37.573, -122.263]].concat(_SM_BRIDGE.slice(1));
    R["Burlingame"]    = [[37.584,-122.344],[37.573,-122.263]].concat(_SM_BRIDGE.slice(1));
    R["Hillsborough"] = [[37.574,-122.345],[37.573,-122.263]].concat(_SM_BRIDGE.slice(1));
    R["San Carlos"]    = [[37.507,-122.260],[37.520,-122.260],[37.573,-122.263]].concat(_SM_BRIDGE.slice(1));
    R["Belmont"]       = [[37.520,-122.276],[37.573,-122.263]].concat(_SM_BRIDGE.slice(1));
    R["Millbrae"]      = [[37.599,-122.387],[37.584,-122.344],[37.573,-122.263]].concat(_SM_BRIDGE.slice(1));
    R["Half Moon Bay"] = [[37.464,-122.429],[37.494,-122.330],[37.573,-122.263]].concat(_SM_BRIDGE.slice(1));
    ...
    R["Novato"]        = [[38.082,-122.550],[38.009,-122.534],[37.974,-122.512],[37.960,-122.530],[37.910,-122.510],[37.882,-122.478]].concat(_MARIN_OAK);
    ...
    var richmondBridgeBranch = [
        ...
        [37.963, -122.512], // I-580 / US-101 interchange
        [37.961, -122.508], // Toll plaza area / approach
        [37.955, -122.500], // Eastbound approach
        [37.945, -122.486], // Point San Quentin approach
        [37.9426, -122.4779], // Bridge West end
        [37.9408, -122.4684], // Bridge mid-west
        [37.9365, -122.4543], // Bridge mid
        [37.9355, -122.4495], // Bridge mid-east
        [37.9323, -122.4054], // Bridge East end / Point Richmond
        [37.932, -122.400], // I-580 / Castro St
        [37.927, -122.373], // I-580 Knox Freeway
        [37.922, -122.356], // I-580 / Cutting Blvd
